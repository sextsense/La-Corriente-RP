...
function setUniform(job, playerPed)
	TriggerEvent('skinchanger:getSkin', function(skin)
		if skin.sex == 0 then
			...
			ESX.ShowNotification(_U('equipado_notificacion'))
			ESX.ShowNotification(_U('division_notificacion'))
		else
...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = _U('chaleco_ciudad'), value = 'chaleco_ciudad' },
		{ label = _U('gilet_wear'), value = 'gilet_wear' },
		{ label = _U('gendarmeria_wear'), value = 'gendarmeria_wear' }
	}

	if grade == 'recruit' then
		table.insert(elements, {label = _U('police_wear'), value = 'recruit_wear'}) -- 1 
	elseif grade == 'cabo' then
		table.insert(elements, {label = _U('police_wear'), value = 'cabo_wear'}) -- 2
	elseif grade == 'cabo1' then
		table.insert(elements, {label = _U('police_wear'), value = 'cabo1_wear'}) -- 3
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - ANTIDISTURBIOS ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_blackops_01', femaleModel = 's_m_y_blackops_01'})
	elseif grade == 'sargento' then
		table.insert(elements, {label = _U('police_wear'), value = 'sargento_wear'}) -- 4
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = _U('unidadaerea_wear'), value = 'unidadaerea_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - SWAT ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
		table.insert(elements, {label = '🚨 [ DIVISION - ANTIDISTURBIOS ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_blackops_01', femaleModel = 's_m_y_blackops_01'})
	elseif grade == 'sargento1' then
		table.insert(elements, {label = _U('police_wear'), value = 'sargento1_wear'}) -- 5
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = _U('unidadaerea_wear'), value = 'unidadaerea_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - SWAT ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
		table.insert(elements, {label = '🚨 [ DIVISION - ANTIDISTURBIOS ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_blackops_01', femaleModel = 's_m_y_blackops_01'})
	elseif grade == 'subaux' then
		table.insert(elements, {label = _U('police_wear'), value = 'subaux_wear'}) -- 6
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = _U('unidadaerea_wear'), value = 'unidadaerea_wear'}) -- 3
		table.insert(elements, {label = _U('francotirador_wear'), value = 'francotirador_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - SWAT ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
		table.insert(elements, {label = '🚨 [ DIVISION - ANTIDISTURBIOS ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_blackops_01', femaleModel = 's_m_y_blackops_01'})
	elseif grade == 'officer' then
		table.insert(elements, {label = _U('police_wear'), value = 'officer_wear'}) -- 7
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = _U('unidadaerea_wear'), value = 'unidadaerea_wear'}) -- 3
		table.insert(elements, {label = _U('francotirador_wear'), value = 'francotirador_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - SWAT ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
	...
	elseif grade == 'sergeant' then
		table.insert(elements, {label = _U('police_wear'), value = 'sergeant_wear'}) -- 8
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = _U('unidadaerea_wear'), value = 'unidadaerea_wear'}) -- 3
		table.insert(elements, {label = _U('francotirador_wear'), value = 'francotirador_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - SWAT ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
	...
	elseif grade == 'intendent' then
		table.insert(elements, {label = _U('police_wear'), value = 'intendent_wear'}) -- 9
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = _U('unidadaerea_wear'), value = 'unidadaerea_wear'}) -- 3
		table.insert(elements, {label = _U('francotirador_wear'), value = 'francotirador_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - SWAT ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
	...
	elseif grade == 'lieutenant' then
		table.insert(elements, {label = _U('police_wear'), value = 'lieutenant_wear'}) -- 10
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = _U('unidadaerea_wear'), value = 'unidadaerea_wear'}) -- 3
		table.insert(elements, {label = _U('francotirador_wear'), value = 'francotirador_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - SWAT ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
	...
	elseif grade == 'chef' then
		table.insert(elements, {label = _U('police_wear'), value = 'chef_wear'}) -- 11
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = _U('unidadaerea_wear'), value = 'unidadaerea_wear'}) -- 3
		table.insert(elements, {label = _U('francotirador_wear'), value = 'francotirador_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - SWAT ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
	...
	elseif grade == 'boss' then
		table.insert(elements, {label = _U('police_wear'), value = 'boss_wear'}) -- 12
		table.insert(elements, {label = _U('gomf_wear'), value = 'gomf_wear'}) -- 3
		table.insert(elements, {label = _U('unidadaerea_wear'), value = 'unidadaerea_wear'}) -- 3
		table.insert(elements, {label = _U('francotirador_wear'), value = 'francotirador_wear'}) -- 3
		table.insert(elements, {label = '🚨 [ DIVISION - SWAT ] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
...
--		table.insert(elements, {label = '🚨 [DIVISION - SWAT] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
				...
				ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
					...
					TriggerEvent('skinchanger:loadDefaultModel', isMale, function()
						ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
							...
							ESX.ShowNotification(_U('ropacivil_notificacion'))
						end)
					end)
		...
		if
			...
			data.current.value == 'gomf_wear' or
			data.current.value == 'cabo1_wear' or 
			data.current.value == 'sargento_wear' or
			data.current.value == 'subaux_wear' or
			data.current.value == 'sargento1_wear' or
			data.current.value == 'officer_wear' or 
			data.current.value == 'unidadaerea_wear' or
			data.current.value == 'sergeant_wear' or
			data.current.value == 'intendent_wear' or
			data.current.value == 'lieutenant_wear' or 
			data.current.value == 'gendarmeria_wear' or
			data.current.value == 'chef_wear' or
			data.current.value == 'boss_wear' or
			data.current.value == 'bullet_wear' or
			data.current.value == 'chaleco_ciudad' or
			data.current.value == 'francotirador_wear' or
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elements = {
			...
			{label = ('✅ Pedir Refuerzos'),		value = 'refuerzos'},
			{label = ('✅ Pedir LSFD'),		value = 'refuerzos2'}
	}}, function(data, menu)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						...
						ExecuteCommand("do Tendria armas o objetos ilictos?.")
					...
					elseif action == 'put_in_vehicle' then
						ExecuteCommand("me Abre la puerta, lo mete y le abrocha el cinturon.")
						TriggerServerEvent('esx_policejob:putInVehicle', GetPlayerServerId(closestPlayer))
					elseif action == 'out_the_vehicle' then
						ExecuteCommand("me Abre la puerta, le desabrocha el cinturon y lo saca.")
						TriggerServerEvent('esx_policejob:OutVehicle', GetPlayerServerId(closestPlayer))
					elseif action == 'fine' then
						ExecuteCommand("me Saca el bloc de notas de su bolsillo")
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_interaction', {
				...
				elseif DoesEntityExist(vehicle) then
					...
					elseif action == 'hijack_vehicle' then
						ESX.ShowNotification(_U('comienzo_choreada'))
						ESX.ShowNotification(_U('ayuda_forjar'))
						ESX.ShowNotification(_U('division_notificacion'))
						if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 3.0) then
							...
							ESX.ShowNotification(_U('bien_hecho'))
							ESX.ShowNotification(_U('division_notificacion'))
						end
					elseif action == 'impound' then
						...
						ESX.ShowNotification(_U('comienzo_confiscar'))
						ESX.ShowNotification(_U('ayuda_confiscar'))
						ESX.ShowNotification(_U('division_notificacion'))
		...
		elseif data.current.value == 'refuerzos' then
					...
					ExecuteCommand("me Pide refuerzos policiales")
				menu.close()
		elseif data.current.value == 'refuerzos2' then
					local playerPed = PlayerPedId()
					PedPosition		= GetEntityCoords(playerPed)
					local PlayerCoords = { x = PedPosition.x, y = PedPosition.y, z = PedPosition.z }
					TriggerServerEvent('esx_addons_gcphone:startCall', 'ambulance', ('SAME 10-20'), PlayerCoords, {
						PlayerCoords = { x = PedPosition.x, y = PedPosition.y, z = PedPosition.z },
					})
					ExecuteCommand("me Pide refuerzos al SAME")
				menu.close()
		elseif data.current.value == 'object_spawner' then
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				elements = {
					...
					{label = _U('barrera_dura'), model = 'prop_mp_barrier_02b'},
					{label = _U('box'), model = 'p_secret_weapon_02'},
					{label = _U('transito'), model = 'prop_mp_arrow_barrier_01'}
			}}, function(data2, menu2)
				local playerPed = PlayerPedId()
				local coords    = GetEntityCoords(playerPed)
...
RegisterCommand('chaleco', function()
	if PlayerData.job ~= nil and PlayerData.job.name == 'police' and PlayerData.job.grade > 3 then
		local playerPed = PlayerPedId()
	if tiene == false then
	TriggerEvent('skinchanger:getSkin', function(skin)
		if skin.sex == 0 then
			if Config.Uniforms['chaleco_ciudad'].male ~= nil then
				TriggerEvent('skinchanger:loadClothes', skin, Config.Uniforms['chaleco_ciudad'].male)
			end
		else
			if Config.Uniforms['chaleco_ciudad'].female ~= nil then
				TriggerEvent('skinchanger:loadClothes', skin, Config.Uniforms['chaleco_ciudad'].female)
			end
		end
	end)
	tiene = true
...
Citizen.CreateThread(function()
	while true do
		...
		if isHandcuffed then
			...
			DisableControlAction(0, 183,  true) -- G
