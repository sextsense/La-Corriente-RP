...
AddEventHandler('esx_policejob:buyitem', function(item, price)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
ESX.RegisterServerCallback('esx_policejob:comprarmunicion', function(source, cb, weaponName, type, componentNum)
	local xPlayer = ESX.GetPlayerFromId(source)
	local authorizedWeapons, selectedWeapon = Config.AuthorizedItems[xPlayer.job.grade_name]
