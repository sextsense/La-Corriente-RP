...
RegisterNetEvent('esx_basicneeds:putChaleco')
AddEventHandler('esx_basicneeds:putChaleco', function(playerPed)
	...
	TriggerEvent('skinchanger:getSkin', function(skin)
		...
		TriggerEvent('skinchanger:loadClothes', skin, clothesSkinMale)
...
RegisterNetEvent('esx_basicneeds:onDrinkMartini')
AddEventHandler('esx_basicneeds:onDrinkMartini', function(prop_name)
	if not IsAnimated then
