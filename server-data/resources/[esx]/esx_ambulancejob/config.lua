...
Config.AuthorizedVehicles = {
	...
	ambulance = {
		{ model = 'ambulance', label = 'Ambulance Van', price = 350}
	},
...
Config.AuthorizedHelicopters = {
	...
	doctor = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 1500 }
	},

	chief_doctor = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 1500 },
		{ model = 'seasparrow', label = 'Sea Sparrow', price = 3000 }
	},

	boss = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 1000 },
		{ model = 'seasparrow', label = 'Sea Sparrow', price = 2500 }
	}
